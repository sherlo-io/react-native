        ...
        mBgHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (tag == -1) {
                    ...
                    view = currentActivity.getWindow().getDecorView().findViewById(android.R.id.content).getRootView();
                } else {
                    ViewGroup viewGroup = (ViewGroup) nativeViewHierarchyManager.resolveView(tag);
                    if (snapshotContentContainer) {
                        ViewGroup innerViewGroup = (ViewGroup) viewGroup.getChildAt(0);
                        view = innerViewGroup;
                    } else {
